      ...
      <div className="pfooter">
        ...
        <div style={{
          ...
          <div style={{ maxWidth: "700px", margin: "0 auto" }}>
            ...
            >
              <a href="https://los-potrillos-restaurant.cloveronline.com/menu/all" className="pfooter-cta-primary">Order Pickup Now →</a>
              <a href="/contact" className="pfooter-cta-secondary">Get a Catering Quote →</a>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div>
                ...
                <div className="pfooter-social">
                  ...
                  {/* Instagram */}
                  <a href="https://www.instagram.com/potrillosrestaurantphilly/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  ...
                  {/* Facebook */}
                  <a href="https://www.facebook.com/lospotrillosrestaurantphilly" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                    <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  {/* TikTok */}
                  <a href="https://www.tiktok.com/@lospotrillosrestaurant" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
                    <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://los-potrillos-restaurant.cloveronline.com/menu/all" className="pfooter-order-link" style={{ marginBottom: "18px", display: "inline-flex" }}>
                  Order Pickup →
                </a>

                {/* Catering */}
                <p className="pfooter-col-heading" style={{ marginTop: "16px", marginBottom: "8px" }}>Catering</p>
                <a href="/contact" className="pfooter-order-link">
                  Get a Quote →
                </a>
